...
/**
 * Test case for DingTalk Robot Alert Notify
 */
@ExtendWith(MockitoExtension.class)
class DingTalkRobotAlertNotifyHandlerImplTest {
    ...
    public void setUp() {
        ...
        when(alerterProperties.getDingTalkWebhookUrl()).thenReturn("http://test.url/");
