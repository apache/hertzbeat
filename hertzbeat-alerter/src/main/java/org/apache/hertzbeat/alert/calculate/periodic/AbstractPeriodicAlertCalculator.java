...
/**
 * Abstract base class for periodic alert calculators
 */
@Slf4j
public abstract class AbstractPeriodicAlertCalculator {
    ...
    protected AbstractPeriodicAlertCalculator(AlarmCommonReduce alarmCommonReduce,
    ...
    /**
     * Perform the actual calculation for the alert definition
     * @param define The alert definition
     * @param currentTimeMilli Current timestamp
     */
    protected abstract void doCalculate(AlertDefine define, long currentTimeMilli);
