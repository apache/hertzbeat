...
public class ThresholdExpressionLexer extends Lexer {
	...
	public ThresholdExpressionLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "ThresholdExpression.g4"; }
