...
- Apache HertzBeat Release 分支 [https://dist.apache.org/repos/dist/release/incubator/hertzbeat](https://dist.apache.org/repos/dist/release/incubator/hertzbeat)
...
邮件内容中的一项是`Vote thread`，在 [https://lists.apache.org/list.html?general@incubator.apache.org](https://lists.apache.org/list.html?general@incubator.apache.org) 查看获取
