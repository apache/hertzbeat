...
> 2. 访问 [https://platform.openai.com/usage](https://platform.openai.com/usage)
> 3. 找到 [https://api.openai.com/dashboard/billing/usage](https://api.openai.com/dashboard/billing/usage) 请求
