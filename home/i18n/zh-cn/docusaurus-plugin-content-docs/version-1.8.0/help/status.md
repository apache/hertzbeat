...
| 网站链接 | 组织网站的 URL，便于访问者获取更多信息                  | [https://hertzbeat.apache.org/](https://hertzbeat.apache.org/)                                                                     |
| 标志图片 | 组织官方标志或 Logo 的图片文件路径或 URL，建议使用 .svg 格式 | [https://hertzbeat.apache.org/zh-cn/img/hertzbeat-logo.svg](https://hertzbeat.apache.org/zh-cn/img/hertzbeat-logo.svg)                                         |
| 反馈地址 | 接收问题反馈的地址                              | [https://github.com/apache/hertzbeat/issues](https://github.com/apache/hertzbeat/issues)                                                        |
