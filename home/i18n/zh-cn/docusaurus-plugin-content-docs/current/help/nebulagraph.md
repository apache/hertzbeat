...
默认端口是 19669，访问地址为 [http://ip:19669/stats](http://ip:19669/stats)

1.2、如果需要获取 rocksdb stats 的附加参数，需要确保可以访问 rocksdb stats，否则会报错。

首次连接 NebulaGraph 时，必须先注册 Storage 服务，以便正确查询数据。

**有帮助文档：[https://docs.nebula-graph.com.cn/3.4.3/4.deployment-and-installation/connect-to-nebula-graph/](https://docs.nebula-graph.com.cn/3.4.3/4.deployment-and-installation/connect-to-nebula-graph/)**
...
默认端口是 19779，访问地址为：[http://ip:19779/rocksdb_stats](http://ip:19779/rocksdb_stats)
