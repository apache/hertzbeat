...
/**
 * OTLP gRPC logs service.
 */
@Service
@RequiredArgsConstructor
public class OtlpGrpcLogsService extends LogsServiceGrpc.LogsServiceImplBase {
    ...
    public void export(ExportLogsServiceRequest request, StreamObserver<ExportLogsServiceResponse> responseObserver) {
        try {
            responseObserver.onNext(otlpGrpcIngestionService.ingestLogsGrpc(request));
