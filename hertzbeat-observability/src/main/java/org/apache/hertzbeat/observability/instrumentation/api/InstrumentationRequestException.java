...
/** Minimal typed request failure used to keep the Message envelope machine-actionable. */
public class InstrumentationRequestException extends IllegalArgumentException {

    private final RequestErrorCode errorCode;

    public InstrumentationRequestException(RequestErrorCode errorCode) {
