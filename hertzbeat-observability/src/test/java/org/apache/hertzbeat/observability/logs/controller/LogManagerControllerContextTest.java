...
class LogManagerControllerContextTest {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            ...
            .withBean(LogManagementServiceImpl.class)
            .withBean(LogManagerController.class);

    @Test
    void contextStartsWhenMultipleHistoryDataWritersArePresent() {
        contextRunner.run(context -> {
            assertThat(context).hasNotFailed();
            assertThat(context).hasSingleBean(LogManagerController.class);
        });
    }
}
