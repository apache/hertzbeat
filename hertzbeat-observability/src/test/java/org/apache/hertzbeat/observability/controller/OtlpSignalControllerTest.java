...
class OtlpSignalControllerTest {
    ...
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(
                new OtlpSignalController(signalForwarder, logIngestionService, new SignalWorkloadGuard())).build();
    }
    ...
    void shouldRouteAllThreeSignals() throws Exception {
        ...
        verifyNoMoreInteractions(signalForwarder, logIngestionService);
    }
