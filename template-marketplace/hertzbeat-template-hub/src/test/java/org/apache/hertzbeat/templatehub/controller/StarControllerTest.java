...
class StarControllerTest {
    ...
    @Deprecated
    @Test
    public void testGetAllVersionByUserStar_ValidUserId() throws Exception {
        List<Version> versions = Collections.singletonList(new Version());
        when(starService.getVersionByUserStar(anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(versions);
    ...
    public void testGetVersionPageByUserStar_ValidInput() throws Exception {
        ...
        when(starService.getPageByUserStar(anyInt(), anyInt(), anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(versionPage);
    ...
    public void testCancelStar_CancelVersionServiceFailed() throws Exception {
        // Mock the service methods
        when(starService.cancelStarByUser(anyInt(), anyInt())).thenReturn(true);
        when(versionService.cancelStarVersion(anyInt())).thenReturn(0);
