...
class CategoryDOControllerTest {
    ...
    public void testGetAllCategory_ValidInput() throws Exception {
        List<CategoryDO> categories = Collections.singletonList(new CategoryDO());
    ...
    public void testGetCategoryPageByIsDel_ValidInput() throws Exception {
        ...
        categories.add(new CategoryDO());
        Page<CategoryDO> categoryPage = new PageImpl<>(categories);
