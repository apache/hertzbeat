...
class VersionDOControllerTest {
    ...
    public void testGetVersionById_ValidVersionId() throws Exception {
        ...
        when(versionService.getVersion(anyInt())).thenReturn(versionDO);
    ...
    public void testGetVersionPageByTemplate_ValidParameters() throws Exception {
        List<VersionDO> versionDOS = new ArrayList<>();
        versionDOS.add(new VersionDO());
        Page<VersionDO> versionPage = new PageImpl<>(versionDOS);
