...
--
-- Current V200 schema baseline for provisioning an empty MySQL target.
-- Historical databases apply the same-version V200 migration instead.
    ...
    create index idx_alert_group_workspace
       on hzb_alert_group (workspace_id);
    ...
    create index idx_alert_single_workspace
       on hzb_alert_single (workspace_id);
...
CREATE TABLE hzb_monitor_metric_layout (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    creator VARCHAR(255) NOT NULL,
