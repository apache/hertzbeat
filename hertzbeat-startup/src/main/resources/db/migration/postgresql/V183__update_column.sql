...
CREATE INDEX idx_agent_transcript_run
...
CREATE INDEX idx_agent_scheduled_command_session
    ON hzb_agent_scheduled_command(session_id);
CREATE INDEX idx_agent_scheduled_command_due
...
CREATE TABLE hzb_alert_analysis_policy (
    ...
    minimum_alert_count INTEGER NOT NULL,
