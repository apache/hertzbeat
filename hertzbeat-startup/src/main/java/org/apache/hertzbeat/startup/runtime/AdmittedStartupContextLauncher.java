...
/** Internal launch capability used only while the standalone owner is valid. */
interface AdmittedStartupContextLauncher {

    RunningApplicationContext launchAdmitted(
