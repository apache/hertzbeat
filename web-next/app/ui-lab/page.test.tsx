...
describe('HertzBeat UI lab page', () => {
  it('renders the @hertzbeat/ui showcase with the monitor picker and YML workspace patterns', () => {
    ...
    expect(html).toContain('data-hz-control-baseline-component="HzSourceDocShell"');
    expect(html).toContain('data-hz-ui-lab-source-doc-shell="shared"');
    ...
    expect(html).toContain('data-hz-ui-lab-source-doc-item="webhook"');
    expect(html).toContain('data-hz-ui-lab-source-doc-markdown="shared"');
    expect(html).toContain('data-hz-ui-lab-exception-explorer-composition="shared"');
    expect(html).toContain('data-exception-composition-owner="hertzbeat-ui-panel-data-table-actions"');
    expect(html).toContain('data-hz-ui-lab-exception-table="shared"');
    ...
    expect(source).toContain('data-hz-ui-lab-collector-deploy-package-link="angular-github-releases-link"');
    expect(source).toContain('data-collector-deploy-package-link-owner="angular-nz-modal"');
    ...
    expect(html).toContain('data-alert-notice-rule-search-submit-owner="hertzbeat-ui-search-row"');
    ...
    expect(html).toContain('data-alert-notice-template-search-submit-owner="hertzbeat-ui-search-row"');
    ...
    expect(html).toContain('data-hz-topology-node-icon-kind="endpoint"');
    expect(html).toContain('data-hz-topology-node-icon-name="route"');
    ...
    expect(html).toContain('data-hz-topology-g6-minimap-node-count="8"');
    ...
    expect(html).toContain('data-hz-topology-g6-node-count="8"');
    expect(html).toContain('data-hz-topology-g6-edge-count="7"');
    ...
    expect(html).toContain('data-hz-ui-lab-topology-g6-node-only-relation-state="shared"');
    ...
    expect(html).toContain('data-hz-ui-lab-topology-g6-scale-overflow="650"');
    expect(html).toContain('data-hz-ui-lab-topology-g6-large-graph-overflow-strategy="filter-first"');
    expect(html).toContain('data-hz-ui-lab-topology-g6-large-graph-overflow-policy="filter-first-before-expanded-render"');
    expect(html).toContain('data-hz-ui-lab-topology-g6-render-window-overflow-rendered="200"');
    expect(html).toContain('data-hz-ui-lab-topology-g6-render-window-overflow-hidden="450"');
    ...
    expect(html).toContain('data-hz-topology-g6-summary-total-node-count="500"');
    expect(html).toContain('data-hz-topology-g6-summary-rendered-edge-count="180"');
    expect(html).toContain('200/500 nodes rendered · 180/');
    expect(html).not.toContain('>500 nodes ·');
    ...
    expect(html).toContain('data-hz-ui-lab-static-confirm-preview="non-blocking-inline"');
    expect(source).toContain('uiLabStaticConfirmDialogPreviewClassName');
    expect(source).toContain('data-hz-ui-lab-static-confirm-preview="non-blocking-inline"');
    expect(source).not.toContain('<HzConfirmDialog\n                open\n                tone="critical"');
    expect(source).not.toContain('<HzConfirmDialog\n                    open\n                    tone="critical"');
    ...
    expect(html).toContain('data-hz-topology-metric-table-total-rows="3"');
    ...
    expect(html).toContain('data-hz-topology-metric-table-hidden-row-proof-count="1"');
    ...
    expect(html).toContain('data-hz-topology-legend-icon-name="route"');
    ...
    expect(html).toContain('data-hz-topology-detail-scroll-reset-key="edge:api-warehouse:svc-api:db-warehouse:trace-call:otlp-trace-call:unknown"');
    ...
    expect(html).toContain('data-hz-ui-lab-signal-summary-strip="shared"');
    ...
    expect(html).toContain('data-ui-lab-code-editor="hz-code-editor"');
    expect(html).toContain('data-hz-code-editor="codemirror"');
    ...
    expect(html).toContain('data-ui-lab-code-editor-loading="hz-code-editor"');
