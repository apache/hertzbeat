...
describe('parity route manifest', () => {
  ...
  it('keeps log-stream on the canonical shared log workbench owner', () => {
    expect(getParityRoutePair('log-compatibility-family', 'log-stream-compat')).toMatchObject({
      parityOwner: 'LogManagePage',
      locale: 'en-US',
      screenshotMode: 'viewport',
      primarySelectors: expect.arrayContaining([
        '[data-log-stream-canonical-live-route="log-manage-stream"]',
  ...
  it('keeps the log-integration compatibility entrypoints on the HertzBeat Intake Cortex contract', () => {
    ...
    expect(rootRoute.parityOwner).toBe('buildLogIntegrationIngestionHref');
    expect(sourceRoute.parityOwner).toBe('buildLogIntegrationIngestionHref');
  ...
  it('points entity editor routes at targeted route and shared-surface contracts instead of raw source files', () => {
    expect(getParityRoutePair('entity-family', 'entity-editor-new')).toMatchObject({
      ...
      primarySelectors: expect.arrayContaining([
        ...
        '[data-entity-editor-header-rhythm="hertzbeat-ui-compact"]',
        ...
        '[data-entity-editor-definition-tabs="hertzbeat-ui-bottom-tabs"]',
    ...
    expect(getParityRoutePair('entity-family', 'entity-editor-edit')).toMatchObject({
      ...
      primarySelectors: expect.arrayContaining([
        ...
        '[data-entity-editor-stage-help-trigger="hertzbeat-ui-stepper-help"]',
        '[data-entity-editor-stage-help="hertzbeat-ui-stepper-tooltip"]',
        '[data-entity-editor-edit-stage-posture="hertzbeat-ui-complete-context"]',
        '[data-entity-editor-stage-step-status="relations-ready"]',
        '[data-entity-editor-preview-rail-density="hertzbeat-ui-inline-preview"]',
        '[data-entity-editor-body-placement="hertzbeat-ui-deferred-body"]',
        '[data-entity-editor-definition-tabs="hertzbeat-ui-bottom-tabs"]',
        '[data-entity-type-icon="service"]',
