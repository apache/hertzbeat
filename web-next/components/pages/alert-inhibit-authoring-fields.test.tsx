...
describe('AlertInhibitAuthoringFields', () => {
  ...
  it('renders the shared inhibit authoring field order, previews, and shortcut posture', () => {
    ...
    expect(html.match(/data-cold-label-selector-owner="cold-label-selector"/g)).toHaveLength(2);
    ...
    expect(html).toContain('data-cold-label-selector-record-row="service:db"');
    expect(html).toContain('data-cold-label-selector-remove-row="service:checkout"');
    expect(html).toContain('data-cold-label-selector-remove-row="service:db"');
    expect(html.match(/data-cold-label-selector-draft-row="true"/g)).toHaveLength(2);
