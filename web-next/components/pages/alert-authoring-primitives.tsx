...
export function AlertAuthoringPanel({
  ...
  return (
    <div data-alert-authoring-panel="cold-panel" className={cn('space-y-2', alertAuthoringPanelClassName, className)} {...props}>
      {heading ? (
...
export function AlertAuthoringCallout({
  ...
  return (
    <div data-alert-authoring-callout="cold-panel" className={cn(alertAuthoringPanelClassName, className)} {...props}>
...
export function AlertAuthoringActionPill({
  ...
  return (
    <button
      data-alert-authoring-action-pill="cold-action"
      type={type}
      className={cn(
...
export function AlertAuthoringValuePill({
  ...
  return (
    <span
      data-alert-authoring-value-pill="cold-value"
      className={cn(
