...
describe('AlertGroupAuthoringFields', () => {
  ...
  it('renders the shared group authoring field order and label-key selector', () => {
    ...
    expect(html.match(/data-alert-group-authoring-field-help=/g)).toHaveLength(6);
    ...
    expect(html.match(/data-alert-group-authoring-field-requirement="required"/g)).toHaveLength(6);
    expect(html).not.toContain('data-alert-group-authoring-field-requirement="optional"');
    expect(html.match(/data-alert-group-authoring-field-input-mode="manual"/g)).toHaveLength(4);
    expect(html.match(/data-alert-group-authoring-field-input-mode="selection"/g)).toHaveLength(1);
    expect(html.match(/data-alert-group-authoring-field-input-mode="manual-or-selection"/g)).toHaveLength(1);
    expect(html).toContain('data-alert-group-authoring-field-help="name"');
    expect(html).toContain('data-alert-group-authoring-field-help="enable"');
    expect(html).toContain('data-alert-group-authoring-field-help="group-labels"');
    expect(html).toContain('data-alert-group-authoring-field-help="group-wait"');
    expect(html).toContain('data-alert-group-authoring-field-help="group-interval"');
    expect(html).toContain('data-alert-group-authoring-field-help="repeat-interval"');
    expect(html).toContain(t('alert.group.field.name.help'));
    expect(html).toContain(t('alert.group.field.group-labels.impact'));
    expect(html).toContain(t('alert.group.field.requirement.required'));
    expect(html).toContain(t('alert.group.field.input-mode.manual'));
    expect(html).toContain(t('alert.group.field.input-mode.selection'));
    expect(html).toContain(t('alert.group.field.input-mode.manual-or-selection'));
