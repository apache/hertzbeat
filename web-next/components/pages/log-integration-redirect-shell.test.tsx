...
describe('log integration redirect shell', () => {
  it('renders the shared placeholder shell with HertzBeat OTLP intake and manage CTAs', async () => {
    ...
    expect(html).toContain(t('log.integration.redirect.title'));
    expect(html).toContain(t('log.integration.redirect.cta.ingestion'));
    expect(html).toContain(t('log.integration.redirect.cta.manage'));
