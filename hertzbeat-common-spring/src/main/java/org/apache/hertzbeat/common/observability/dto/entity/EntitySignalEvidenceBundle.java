...
/**
 * Shared entity evidence payload consumed by signal handoffs and entity detail surfaces.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class EntitySignalEvidenceBundle {
    ...
    public static EntitySignalEvidenceBundle from(EntityObservabilityDetailBundle detailBundle) {
        if (detailBundle == null) {
            return new EntitySignalEvidenceBundle(
        ...
        return new EntitySignalEvidenceBundle(
                detailBundle.getLogSummary(),
                detailBundle.getTraceSummary(),
                detailBundle.getMetricEvidence(),
                detailBundle.getLogEvidence(),
                detailBundle.getTraceEvidence(),
                detailBundle.getLogQueryHints(),
                detailBundle.getTraceQueryHints(),
                detailBundle.getUnifiedEvidenceSummary(),
                detailBundle.getTriageRecommendation()
        );
    }
}
