...
metrics_url="${FRONTEND_BASE}/explore?signal=metrics&traceId=${trace_id_q}&spanId=${root_span_id_q}&${common_signal_context}"
...
log_group_by_url="${FRONTEND_BASE}/explore?signal=logs&groupBy=resource%3Aservice.version&groupLimit=8&${common_signal_context}"
log_host_group_by_url="${FRONTEND_BASE}/explore?signal=logs&groupBy=resource%3Ahost.name&groupLimit=8&${common_signal_context}"
log_k8s_pod_group_by_url="${FRONTEND_BASE}/explore?signal=logs&groupBy=resource%3Ak8s.pod.name&groupLimit=8&${common_signal_context}"
trace_group_by_url="${FRONTEND_BASE}/explore?signal=traces&spanScope=all&groupBy=resource%3Aservice.version&groupLimit=8&${common_signal_context}"
trace_host_group_by_url="${FRONTEND_BASE}/explore?signal=traces&spanScope=all&groupBy=resource%3Ahost.name&groupLimit=8&${common_signal_context}"
trace_k8s_pod_group_by_url="${FRONTEND_BASE}/explore?signal=traces&spanScope=all&groupBy=resource%3Ak8s.pod.name&groupLimit=8&${common_signal_context}"
entity_url="${FRONTEND_BASE}/entities/${entity_id_q}?traceId=${trace_id_q}&spanId=${root_span_id_q}&${common_signal_context}"
alert_url="${FRONTEND_BASE}/alerts?status=firing&signal=metrics&search=${service_name_q}&traceId=${trace_id_q}&spanId=${root_span_id_q}&${common_signal_context}"
