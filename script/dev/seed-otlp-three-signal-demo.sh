...
entity_id = sys.argv[11]
entity_name = sys.argv[12]
workspace_id = sys.argv[13]
collector = sys.argv[14]
template = sys.argv[15]
...
common_signal_context="entityId=${entity_id_q}&entityName=${entity_name_q}&serviceName=${service_name_q}&serviceNamespace=${service_namespace_q}&environment=${deployment_environment_q}&collector=${collector_q}&template=${template_q}&source=otlp"
