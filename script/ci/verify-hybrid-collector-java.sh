...
./mvnw -pl hertzbeat-manager,hertzbeat-collector/hertzbeat-collector-collector -am \
  -Dtest='ManagedOtelRuntimeConfigTest,ManagedOtelRuntimeStatusTest,CollectServerTest,HeartbeatProcessorRuntimeConfigTest,OtelRuntimeConfigRendererTest,OtelRuntimeConfigTransactionTest,OtelRuntimeConfigurationTest,OtelRuntimeGatewayPolicyTest,OtelRuntimeSourcePolicyTest,OtelRuntimeSourceStatusesTest,OtelRuntimeSupervisorTest,OtelRuntimeStatusProviderTest,CollectorControllerTest,CollectorRuntimeConfigServiceTest,CollectorRuntimeStatusRegistryTest,HeartbeatProcessorRuntimeStatusTest,CollectorServiceTest,ManageServerTest' \
