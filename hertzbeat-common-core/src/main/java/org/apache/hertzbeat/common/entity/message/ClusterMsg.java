...
public final class ClusterMsg {
  ...
  public enum MessageType
     ...
     * <code>AUTH_CHALLENGE = 10;</code>
     */
    public static final int AUTH_CHALLENGE_VALUE = 10;
    ...
    public static MessageType forNumber(int value) {
      switch (value) {
        ...
        case 3: return GO_CLOSE;
        case 4: return ISSUE_CYCLIC_TASK;
        case 5: return DELETE_CYCLIC_TASK;
        case 6: return ISSUE_ONE_TIME_TASK;
  ...
  public interface MessageOrBuilder extends
     ...
     * </pre>
     *
     * <code>int64 auth_timestamp = 5;</code>
     ...
     * </pre>
     *
     * <code>bytes auth_nonce = 6;</code>
     * @return The authNonce.
     */
    com.google.protobuf.ByteString getAuthNonce();
     ...
     * </pre>
     *
     * <code>bytes auth_signature = 7;</code>
     * @return The authSignature.
     */
    com.google.protobuf.ByteString getAuthSignature();
     ...
     * </pre>
     *
     * <code>uint32 auth_version = 8;</code>
     ...
     * </pre>
     *
     * <code>string auth_key_id = 9;</code>
     ...
     * </pre>
     *
     * <code>bytes auth_channel_nonce = 10;</code>
     * @return The authChannelNonce.
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    private Message() {
      ...
      authKeyId_ = "";
      authChannelNonce_ = com.google.protobuf.ByteString.EMPTY;
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              authTimestamp_ = input.readInt64();
              break;
            }
            case 50: {

              authNonce_ = input.readBytes();
              break;
            }
            case 58: {

              authSignature_ = input.readBytes();
              break;
            }
            case 64: {
            ...
            case 82: {
              ...
              authChannelNonce_ = input.readBytes();
              break;
            }
            default: {
    ...
    public long getAuthTimestamp() {
      return authTimestamp_;
    }

    public static final int AUTH_NONCE_FIELD_NUMBER = 6;
    private com.google.protobuf.ByteString authNonce_;
    /**
     * <pre>
     * per-message random value used to reject replay
     * </pre>
     ...
     */
    @java.lang.Override
    public com.google.protobuf.ByteString getAuthNonce() {
      return authNonce_;
    }

    public static final int AUTH_SIGNATURE_FIELD_NUMBER = 7;
    private com.google.protobuf.ByteString authSignature_;
    /**
     * <pre>
     * HMAC-SHA256 over the message with this field cleared
     * </pre>
     ...
     */
    @java.lang.Override
    public com.google.protobuf.ByteString getAuthSignature() {
      return authSignature_;
    }

    public static final int AUTH_VERSION_FIELD_NUMBER = 8;
    ...
    public static final int AUTH_KEY_ID_FIELD_NUMBER = 9;
    ...
    public static final int AUTH_CHANNEL_NONCE_FIELD_NUMBER = 10;
    private com.google.protobuf.ByteString authChannelNonce_;
    /**
     * <pre>
     * server-generated nonce binding a signed message to one Netty connection
     * </pre>
     ...
     */
    @java.lang.Override
    public com.google.protobuf.ByteString getAuthChannelNonce() {
      return authChannelNonce_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (authTimestamp_ != 0L) {
        output.writeInt64(5, authTimestamp_);
      }
      if (!authNonce_.isEmpty()) {
        output.writeBytes(6, authNonce_);
      }
      if (!authSignature_.isEmpty()) {
        output.writeBytes(7, authSignature_);
      }
      if (authVersion_ != 0) {
        output.writeUInt32(8, authVersion_);
      }
      if (!getAuthKeyIdBytes().isEmpty()) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 9, authKeyId_);
      }
      if (!authChannelNonce_.isEmpty()) {
        output.writeBytes(10, authChannelNonce_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (authTimestamp_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt64Size(5, authTimestamp_);
      }
      if (!authNonce_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(6, authNonce_);
      }
      if (!authSignature_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(7, authSignature_);
      }
      if (authVersion_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, authVersion_);
      }
      if (!getAuthKeyIdBytes().isEmpty()) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(9, authKeyId_);
      }
      if (!authChannelNonce_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(10, authChannelNonce_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getAuthTimestamp()
          != other.getAuthTimestamp()) return false;
      if (!getAuthNonce()
          .equals(other.getAuthNonce())) return false;
      if (!getAuthSignature()
          .equals(other.getAuthSignature())) return false;
      if (getAuthVersion()
          != other.getAuthVersion()) return false;
      if (!getAuthKeyId()
          .equals(other.getAuthKeyId())) return false;
      if (!getAuthChannelNonce()
          .equals(other.getAuthChannelNonce())) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + AUTH_TIMESTAMP_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getAuthTimestamp());
      hash = (37 * hash) + AUTH_NONCE_FIELD_NUMBER;
      hash = (53 * hash) + getAuthNonce().hashCode();
      hash = (37 * hash) + AUTH_SIGNATURE_FIELD_NUMBER;
      hash = (53 * hash) + getAuthSignature().hashCode();
      ...
      hash = (37 * hash) + AUTH_CHANNEL_NONCE_FIELD_NUMBER;
      hash = (53 * hash) + getAuthChannelNonce().hashCode();
    ...
    public static final class Builder extends
      ...
      public org.apache.hertzbeat.common.entity.message.ClusterMsg.Message buildPartial() {
        ...
        result.authNonce_ = authNonce_;
        result.authSignature_ = authSignature_;
        result.authVersion_ = authVersion_;
        result.authKeyId_ = authKeyId_;
        result.authChannelNonce_ = authChannelNonce_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(org.apache.hertzbeat.common.entity.message.ClusterMsg.Message other) {
        ...
        if (other.getAuthTimestamp() != 0L) {
          setAuthTimestamp(other.getAuthTimestamp());
        }
        if (other.getAuthNonce() != com.google.protobuf.ByteString.EMPTY) {
          setAuthNonce(other.getAuthNonce());
        }
        if (other.getAuthSignature() != com.google.protobuf.ByteString.EMPTY) {
          setAuthSignature(other.getAuthSignature());
        }
        ...
        if (other.getAuthChannelNonce() != com.google.protobuf.ByteString.EMPTY) {
          setAuthChannelNonce(other.getAuthChannelNonce());
        }
  ...
  checkByteStringIsUtf8(value);
    ...
    throw new NullPointerException();
       ...
       *
       * <code>int64 auth_timestamp = 5;</code>
       * @param value The authTimestamp to set.
       * @return This builder for chaining.
       */
      public Builder setAuthTimestamp(long value) {

        authTimestamp_ = value;
        onChanged();
        return this;
      }
      /**
      ...
      private com.google.protobuf.ByteString authNonce_ = com.google.protobuf.ByteString.EMPTY;
      /**
       * <pre>
       * per-message random value used to reject replay
       * </pre>
       ...
       *
       * <code>bytes auth_nonce = 6;</code>
       * @param value The authNonce to set.
       * @return This builder for chaining.
       */
      public Builder setAuthNonce(com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
       ...
       * @return This builder for chaining.
       */
      public Builder clearAuthNonce() {

        authNonce_ = getDefaultInstance().getAuthNonce();
        onChanged();
        return this;
      }

      private com.google.protobuf.ByteString authSignature_ = com.google.protobuf.ByteString.EMPTY;
      /**
       * <pre>
       * HMAC-SHA256 over the message with this field cleared
       * </pre>
       ...
       *
       * <code>bytes auth_signature = 7;</code>
       * @param value The authSignature to set.
       * @return This builder for chaining.
       */
      public Builder setAuthSignature(com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }

        authSignature_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearAuthSignature() {

        authSignature_ = getDefaultInstance().getAuthSignature();
        onChanged();
        return this;
      }
  ...
  checkByteStringIsUtf8(value);
      ...
      private com.google.protobuf.ByteString authChannelNonce_ = com.google.protobuf.ByteString.EMPTY;
      /**
       * <pre>
       * server-generated nonce binding a signed message to one Netty connection
       * </pre>
       ...
       *
       * <code>bytes auth_channel_nonce = 10;</code>
       * @param value The authChannelNonce to set.
       * @return This builder for chaining.
       */
      public Builder setAuthChannelNonce(com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }

        authChannelNonce_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearAuthChannelNonce() {

        authChannelNonce_ = getDefaultInstance().getAuthChannelNonce();
        onChanged();
        return this;
      }
      @java.lang.Override
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t.common.entity.message\"\304\002\n\007Message\022\020\n\010i" +
      ...
      "uth_nonce\030\006 \001(\014\022\026\n\016auth_signature\030\007 \001(\014\022" +
      "\024\n\014auth_version\030\010 \001(\r\022\023\n\013auth_key_id\030\t \001" +
    ...
    internal_static_org_apache_hertzbeat_common_entity_message_Message_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_org_apache_hertzbeat_common_entity_message_Message_descriptor,
        new java.lang.String[] { "Identity", "Direction", "Type", "Msg", "AuthTimestamp", "AuthNonce", "AuthSignature", "AuthVersion", "AuthKeyId", "AuthChannelNonce", });
  }
