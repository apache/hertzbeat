...
public interface AnalysisService {
    ...
    /**
     * Train model and forecast future trend
     ...
     * @return List of predicted values (aligned with future steps)
     */
    List<Double> forecast(List<History> historyData, long stepMillis, int forecastCount);
}
