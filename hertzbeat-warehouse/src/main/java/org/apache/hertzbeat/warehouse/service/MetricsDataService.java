...
public interface MetricsDataService {
     ...
     */
    MetricsHistoryData getMetricHistoryData(String instance, @Deprecated String monitorName, String app, String metrics, String metric, String history, Boolean interval);
}
