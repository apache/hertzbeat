...
/**
 * Owns persisted entity identity read evidence.
 */
@Service
public class EntityIdentityReadModelService {

    private final EntityIdentityQueryService entityIdentityQueryService;

    public EntityIdentityReadModelService(EntityIdentityQueryService entityIdentityQueryService) {
