...
public final class SecretValue {
    ...
    private SecretValue(char[] content) {
        this.content = content.clone();
    }

    public static SecretValue of(String content) {
    ...
    public boolean equals(Object other) {
        return other instanceof SecretValue secret && Arrays.equals(content, secret.content);
    }
