...
/** Application boundary implemented by a later setup engine milestone. */
public interface SetupWorkflow {
    ...
    OptionsResponse configureOptions(OptionsRequest request);

    ExportResponse prepareExport(ExportRequest request);
