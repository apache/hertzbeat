 ...
 */
public interface SignalSavedViewDao extends JpaRepository<SignalSavedViewEntity, Long> {

    List<SignalSavedViewEntity> findBySignalOrderByUpdateTimeDesc(String signal);
