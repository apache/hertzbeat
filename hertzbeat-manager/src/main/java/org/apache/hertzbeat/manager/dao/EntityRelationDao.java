...
/**
 * EntityRelation database operation.
 */
public interface EntityRelationDao extends JpaRepository<EntityRelation, Long>, JpaSpecificationExecutor<EntityRelation> {
    ...
    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query("DELETE FROM EntityRelation relation WHERE relation.sourceEntityId = :sourceEntityId OR relation.targetEntityId = :targetEntityId")
    void deleteAllBySourceEntityIdOrTargetEntityId(@Param("sourceEntityId") Long sourceEntityId,
