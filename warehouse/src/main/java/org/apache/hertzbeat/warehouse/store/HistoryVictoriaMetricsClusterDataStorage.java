...
import org.apache.hertzbeat.warehouse.config.store.vm.cluster.VictoriaMetricsClusterProperties;
import org.apache.hertzbeat.warehouse.config.store.vm.cluster.VictoriaMetricsInsertProperties;
import org.apache.hertzbeat.warehouse.config.store.vm.cluster.VictoriaMetricsSelectProperties;
...
@Slf4j
public class HistoryVictoriaMetricsClusterDataStorage extends AbstractHistoryDataStorage {
    ...
    public HistoryVictoriaMetricsClusterDataStorage(VictoriaMetricsClusterProperties vmClusterProps,
