...
import type { SystemConfigDraft, TimezoneOption } from './system-config-model';

export function loadSystemConfig() {
  return apiMessageGet<SystemConfigDraft | null>('/api/config/system');
}
...
export function saveSystemConfig(config: SystemConfigDraft) {
