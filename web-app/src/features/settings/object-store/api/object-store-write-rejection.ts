...
/** Only explicit backend business and HTTP 4xx responses prove that no Object Store write committed. */
export function isDefiniteObjectStoreWriteRejection(reason: unknown) {
