    ...
    children: [
      {
        ...
        label: 'Summary',
        isLeaf: false,
        children: [{ value: 'responseTime', label: 'Response time', isLeaf: true, type: 0, unit: 'ms' }]
      }
    ]
  }
];
...
describe('monitor application hierarchy API', () => {
  ...
  it('normalizes the nullable and defaulted fields emitted by the Java hierarchy DTO', async () => {
    http.apiMessageGet.mockResolvedValue([
      {
        value: 'website',
        children: [{ value: 'summary', label: null, hide: true, children: null }]
      }
    ]);
    ...
    http.apiMessageGet.mockResolvedValue([
      {
        ...
        children: [
          {
            value: 'private-wire-value',
            label: { secret: 'do-not-log' },
            children: []
          }
        ]
      }
