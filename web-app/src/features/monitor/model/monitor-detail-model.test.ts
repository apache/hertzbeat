...
import { buildFavoriteMetricPath, buildHistoryMetricPath, buildMetricCatalogPath, buildRealtimeMetricPath, monitorHistoryRows, monitorMetricOptions, monitorRealtimeRows } from './monitor-detail-model';
